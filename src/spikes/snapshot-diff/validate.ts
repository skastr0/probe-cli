...
import { SimulatorHarness, SimulatorHarnessLive, type OpenedFixtureSession } from "../../services/SimulatorHarness"
...
const main = async () => {
  ...
  let opened: OpenedFixtureSession | null = null
