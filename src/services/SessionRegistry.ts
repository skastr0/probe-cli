      ...
      Effect.gen(function* () {
          ...
          run: () =>
            Effect.gen(function* () {
              ...
              return {
                ...
                hostRttMs: response.hostRttMs ?? null,
              }
            }),
        })
        ...
        return {
          ...
          result: {
            ...
            artifact: null,
            recordingLength: record.recording.steps.length,
            handledMs: actionResult.value.handledMs ?? null,
            resolutionMs: actionResult.value.resolutionMs ?? null,
            waitMs: actionResult.value.waitMs ?? null,
            interactionMs: actionResult.value.interactionMs ?? null,
